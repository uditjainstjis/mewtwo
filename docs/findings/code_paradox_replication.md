...
2. **Adapter-quality dependence:** The 30B adapters were trained on a different, larger curriculum than the small-model adapters from `adapters/small_models_zoo/from_hf_kaggle/`. The smaller adapters may not have absorbed enough code-as-reasoning structure.

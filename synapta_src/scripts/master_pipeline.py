...
def phase_2():
    ...
    for epoch in range(5):
        ...
        if val_acc > best_val_acc:
            ...
            save_dir = PROJECT / "adapters" / "nemotron_30b" / "layer_blend"
    ...
    blend_router.eval()
    blend_save = PROJECT / "adapters" / "nemotron_30b" / "layer_blend" / "best_router.pt"
    ...
    blend_adapter_dir = PROJECT / "adapters" / "nemotron_30b" / "layer_blend_adapter"
...
def phase_3():
    ...
    import zipfile
    blend_dir = PROJECT / "adapters" / "nemotron_30b" / "layer_blend_adapter"

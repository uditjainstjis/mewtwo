...
#   6. To stop: touch adapters/lori_moe/STOP_PIPELINE
#
# Monitor:
...
rm -f "$PROJECT_ROOT/adapters/lori_moe/STOP_PIPELINE"

# ─── Ensure directories ────────────────────────────────────────
echo "[2/4] Ensuring directory structure..."
mkdir -p logs/lori_moe adapters/lori_moe data/lori_moe
...
echo "║                                                       ║"
echo "║  To stop:    touch adapters/lori_moe/STOP_PIPELINE ║"

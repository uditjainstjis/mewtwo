...
def main() -> None:
    ...
    parser.add_argument("--sft-output-dir", default="adapters/routers/router_reasoning_sft")
    parser.add_argument("--grpo-output-dir", default="adapters/routers/router_reasoning_grpo")

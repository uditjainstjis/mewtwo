...
def train_adapter(
    ...
    output_dir: str = "/home/learner/Desktop/mewtwo/adapters/lori_moe/adapters",
    rank: int = 32,
    alpha: float = 64.0,
    sparsity: float = 0.8,
    shared_b_seed: int = 42,
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="/home/learner/Desktop/mewtwo/adapters/lori_moe/adapters")

...
STATE_FILES = [
    f"{PROJECT_ROOT}/checkpoints/lori_moe/pipeline_state.json",
    f"{PROJECT_ROOT}/checkpoints/lori_moe/shadow_state.json"
]
CONFIG_FILE = f"{PROJECT_ROOT}/checkpoints/lori_moe/queue_config.json"
...
def start_pipeline():
    stop_signal = f"{PROJECT_ROOT}/checkpoints/lori_moe/STOP_PIPELINE"
...
def reset_pipeline():
    state_file = f"{PROJECT_ROOT}/checkpoints/lori_moe/pipeline_state.json"

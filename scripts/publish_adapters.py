...
ADAPTERS = {
    "math": {
        "source": PROJECT_ROOT / "checkpoints/nemotron_lori/adapters/math/best",
    ...
    "code": {
        "source": PROJECT_ROOT / "checkpoints/nemotron_lori/adapters/code/best",
    ...
    "science": {
        "source": PROJECT_ROOT / "checkpoints/nemotron_lori/adapters/science/best",
    ...
    "merged": {
        "source": PROJECT_ROOT / "submission_adapter",

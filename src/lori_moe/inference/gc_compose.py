...
Usage:
    python -m src.lori_moe.inference.gc_compose \
        ...
        --gc_router_path ./checkpoints/nemotron_lori/gc_router/best/gc_router.pt \
...
def main():
    ...
    parser.add_argument("--gc_router_path", type=str, default=str(PROJECT_ROOT / "checkpoints" / "nemotron_lori" / "gc_router" / "best" / "gc_router.pt"))

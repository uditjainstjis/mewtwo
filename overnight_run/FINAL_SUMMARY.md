...
5 specific bugs in `src/demo/server.py`. Drop-in fix at `overnight_run/demo_artifacts/server_fixed.py`. Polish smoke (max=512) shows **all 4 modes hit 95% pass rate** on 20 prompts. The demo is fully validated for inference. Two-line deploy:

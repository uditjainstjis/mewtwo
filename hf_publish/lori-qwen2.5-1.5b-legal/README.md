...
library_name: peft
license: apache-2.0
model_name: uditjain/lori-qwen2.5-1.5b-legal
tags:
- peft
- lora
- adapter
...
# LoRI Legal Adapter for Qwen2.5-1.5B-Instruct
...
Legal-text analysis research, clause classification style prompts, and domain-steering experiments.

## Training Data

This adapter was trained from the prepared domain corpus in `mewtwo/data/lori_moe`.

- Final prepared example count: `109`
- Average tokenized sequence length statistic: `810.3`
- Source datasets / preparation path:
  - nguha/legalbench: contract_nli_explicit_identification
  - nguha/legalbench: learned_hands_benefits (fallback)
...
- Best recorded training loss: `0.000013`
- Recorded training time: `17.54 minutes`
...
adapter_id = "uditjain/lori-qwen2.5-1.5b-legal"
...
- This is not legal advice. The training corpus is small in the final prepared dataset, so robustness is limited and outputs must be reviewed by qualified professionals.

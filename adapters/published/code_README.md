...
model-index:
- name: nemotron-30b-code-hyper-reasoner-peft
  results:
  - task:
...
# Nemotron-30B Code Hyper-Reasoner PEFT

Welcome to the **Nemotron-30B Code Hyper-Reasoner PEFT**, a specialized parameter-efficient fine-tuning (PEFT) module designed for the `nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16` architecture. 
...
- **Training Time:** ~8.1 hours (486.7 min)
- **Dataset:** ~15K samples from `sahil2801/CodeAlpaca-20k`
- **Total Steps:** 1,250
...
| Benchmark | Base Model | Nemotron-30B Code Hyper-Reasoner PEFT | Delta |
| :--- | :--- | :--- | :--- |
| **ARC-Challenge** (25-shot) | 20.0% | **31%** | 11% |
| **HumanEval** (0-shot) | 50.0% | **27%** | -23% |
...
adapter_id = "uditjain/nemotron-30b-code-hyper-reasoner-peft"
...
@misc{jain2026nemotronmath,
  ...
  url = {https://huggingface.co/uditjain/nemotron-30b-code-hyper-reasoner-peft}
}
```
